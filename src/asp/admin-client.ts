 ...
 * and `allowlist`; the v3-schema profile fields (`display_name`,
 * `visibility`, `description`, `card_body`) may be absent. The TypeScript
 * cast lies in those cases and the renderer ends up printing `undefined`
 * or crashing on `.length` of an undefined string.
 *
